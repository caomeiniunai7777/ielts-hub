...
- [2026-08-19 23:17:16] IELTS Hub deployed to GitHub Pages: https://caomeiniunai7777.github.io/ielts-hub/ — repo: github.com/caomeiniunai7777/ielts-hub (personal account). Vocab OCR complete: 2190 words extracted from 336-page scanned PDF (EasyOCR, two-column layout). Full data: vocabulary.js (2190 words/22 chapters) + synonyms538.js (376 groups). Watermark filtering applied (小恩雅思 watermark on ~4 pages).
